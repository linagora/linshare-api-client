(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["LinshareApiClient"] = factory();
	else
		root["LinshareApiClient"] = factory();
...
var httpClient = __webpack_require__(14);
...
var BASE_PATH = '/user/v2';

module.exports = function (client) {
  return {
    authentication: __webpack_require__(38)(client, BASE_PATH),
    documents: __webpack_require__(39)(client, BASE_PATH),
    shares: __webpack_require__(40)(client, BASE_PATH),
    workgroup: __webpack_require__(41)(client, BASE_PATH),
    sharedSpaceNodes: __webpack_require__(42)(client, BASE_PATH),
    sharedSpaceRoles: __webpack_require__(43)(client, BASE_PATH)
  };
};
...
module.exports = function (client, parentPath) {
  var BASE_PATH = parentPath + "/authentication";
...
module.exports = function (client, parentPath) {
  var BASE_PATH = parentPath + '/documents';
...
module.exports = function (client, parentPath) {
  var BASE_PATH = parentPath + '/shares';
  ...
  function shareDocuments() {
    ...
    return client.api({
      url: BASE_PATH,
      method: 'POST',
      data: { documents: documents, recipients: recipients }
    });
  }
};
...
module.exports = function (client, parentPath) {
  var BASE_PATH = parentPath + '/work_groups';

  return {
    createDocumentFromUrl: createDocumentFromUrl,
    createInWorkgroupNode: createInWorkgroupNode,
    createInWorkgroupNodeFromUrl: createInWorkgroupNodeFromUrl,
  ...
  function createDocumentFromUrl(workGroupUuid) {
    var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
        url = _ref.url,
    ...
    return client.api({
      ...
      method: 'POST',
      data: { url: url, fileName: fileName, size: size },
      params: { parent: parent, async: async, strict: strict }
    });
  }

  function createInWorkgroupNode(formData) {
    var _ref3 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
        async = _ref3.async,
        onUploadProgress = _ref3.onUploadProgress;

    var workGroupUuid = arguments[2];
  ...
  function createInWorkgroupNodeFromUrl() {
  ...
  function listNodes(workGroupUuid) {
  ...
  function downloadDocument(workGroupUuid, documentUuid) {
    var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : { responseType: 'blob' };
...
module.exports = function (client, parentPath) {
  var BASE_PATH = parentPath + "/shared_space_nodes";

  return {
    findMemberByAccountUuid: findMemberByAccountUuid
  };
...
module.exports = function (client, parentPath) {
  var BASE_PATH = parentPath + "/shared_space_roles";
...
//# sourceMappingURL=linshare-api-client.js.map